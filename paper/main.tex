...
\input{sections/03-deployed-today}

\fluxpart{Part II}{Chain and money}
\input{sections/04-consensus}
\input{sections/05-monetary-policy}
\input{sections/06-parallel-assets}
\input{sections/07-pnr}
\input{sections/08-chain-evolution}

\fluxpart{Part III}{The cloud}
\input{sections/09-fluxos}
\input{sections/10-appspec-v9}
\input{sections/11-one-platform}
\input{sections/12-networking}
\input{sections/13-managed-services}
\input{sections/14-attested-execution}

\fluxpart{Part IV}{Agents and value}
\input{sections/15-accelerated-compute}
\input{sections/16-paying-for-capacity}
\input{sections/17-agent-identity}
\input{sections/18-agent-native-cloud}
\input{sections/19-natural-language-deployment}
\input{sections/20-shielded-value}
\input{sections/21-private-payment}
\input{sections/22-bridging}
\input{sections/23-governance}

\fluxpart{Part IV.5}{The complete network}
\input{sections/23b-end-to-end}

\fluxpart{Part V}{Assessment}
\input{sections/24-feasibility}
\input{sections/25-evaluation}
\input{sections/26-migration}
\input{sections/27-related-work}
\input{sections/28-limitations}
\input{sections/29-conclusion}
...
\appendix
\clearpage
\input{sections/A-constants}
\clearpage
\input{sections/B-interfaces}
\clearpage
\input{sections/C-emission-model}
\clearpage
\input{sections/D-notation-index}
\clearpage
\input{sections/E-roadmap-timeline}
