...
%% Read from a private repository with the coordinates deliberately withheld. Used only for the
%% security-finding class of S14; see \S14's disposition subsection and \S28 for why.
\newcommand{\srcprivate}[1]{\textsf{\footnotesize[private~source:~#1]}}
...
\newcommand{\hshield}{\ensuremath{h_{\mathrm{shield}}}}               % shielded-pool sunset height (round 37: 3,600,000 = 2027-04-27, announced at publication, before \hpa; earlier rounds 11/33 had \hpa + 1,051,200); introduced in \S20. Round 18, G25.
...
\newcommand{\hopen}{\ensuremath{h^{\mathrm{mig}}_{\mathrm{open}}}}       % redemption window opens: nothing can be swapped into a retiring chain; swapping back and claiming continue (rounds 34-36; 3,450,000 = 2027-03-06)
\newcommand{\hclose}{\ensuremath{h^{\mathrm{mig}}_{\mathrm{close}}}}     % retiring chains shut down; residue to the Foundation (rounds 34, 36; 3,880,000 = 2027-08-02)
