...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[lbl, above=1mm of ha] {TLS termination, Host-header ACL,\\[-1pt]per-server health check};
    \node[lbl, below=13mm of dns, anchor=north] {};
    \node[draw, dashed, rounded corners=2pt, inner sep=3mm, fit=(dns)(ha),
          label={[lbl, yshift=1mm]above:{Foundation-operated}}] {};
  \end{tikzpicture}
