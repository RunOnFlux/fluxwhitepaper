...
\srcintent{00-scope.md}. The reason this section exists is structural, not archival: three fields
...
code paths will be removed \srcintent{08-answers-round-2.md, v9 migration bullet}. This paper states
...
\srcintent{08-answers-round-2.md, v9 migration bullet}. Non-eviction would be preserved; opt-out
would not exist.
...
\srcintent{08-answers-round-2.md, round 3 answers}. Those three properties are what would make the
...
\srcintent{08-answers-round-2.md, round 5 answers}. Enforcement is by \textbf{\FluxOS}, not by
...
existing applications in the same quarter} \srcintent{08-answers-round-2.md, round 11} (\planned).
That places $\hstar$ before $\hpa = \num{3466630}$ (2027-03-12), so the specification change
...
\settlednote{$\hstar = \num{3050000}$ \srcintent{08-answers-round-2.md, round 17},
...
$\hpa = \num{3466630}$. That ordering is what \S\ref{sec:feasibility} requires: the \specv{9}
economic fields land, and are given roughly five months to prove themselves, before \PNR{}, credits,
...
\srcintent{08-answers-round-2.md, round 17}. This is a deliberate decoupling rather than an
