...
the user never sees either \srcintent{08-answers-round-2.md, round 5}
...
\srcintent{plan/mech-agent-identity.md \S0} \\
\hline
\end{tabular}
...
\srcintent{08-answers-round-2.md, round 5}. That is the operator's decision and not a
...
same question. \planned \srcintent{plan/mech-agent-identity.md \S1.3}.
...
\srcintent{plan/mech-agent-identity.md \S1.3,\S1.5}. The qualifier is load-bearing and is
