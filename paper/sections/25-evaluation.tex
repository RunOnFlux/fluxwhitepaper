...
\srcintent{evidence/design/02-pnr.md} for the settled design (an 80\%/20\% Foundation/operator
...
extrapolations (\S\ref{sec:eval-threats}). \srcintent{evidence/design/02-pnr.md};
