...
Modelled figures come from two independent, stdlib-only Python scripts, executed
2026-09-03 and 2026-09-07 respectively, both deterministic given the pinned constants they read, and both citable in full in
...
870,387 blocks short of the planned activation height $\hpa = 3{,}787{,}502$ (approximately
2027-07-01 at 30 s spacing). Everything in this subsection is therefore a \planned projection —
...
\srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07} for every number computed from it — and is
...
\srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07}.}
\label{tab:eval-pnr-flux}
\end{table}

The two levers (falling subsidy, rising $\nodeshare$) would together bring the parity requirement
down from 31.9 M to 6.8 M FLUX/yr over 5.3 years and to 1.7 M FLUX/yr on the perpetual tail. Whether
...
\midrule
0\% & never & --- & --- \\
10\% & 2038-10 & 4.21 M & 0.50 \\
25\% & 2034-10 & 7.33 M & 0.50 \\
50\% & 2032-10 & 12.4 M & 0.50 \\
100\% & 2030-10 & 14.3 M & 0.40 \\
200\% & 2029-10 & 18.3 M & 0.35 \\
\bottomrule
\end{tabular}
\caption{Modelled crossover year under constant annual revenue growth from $V_0$.
\srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07}; data in \texttt{paper/\allowbreak{}data/\allowbreak{}pnr\_crossover.\allowbreak{}dat}
...
given year: 162\%/yr by 2029, 82\%/yr by 2030, 51\%/yr by 2031, 34\%/yr by 2032, 26\%/yr by 2033,
...
\midrule
0\% & 14.3 & never & never & never & never \\
10\% & 7.3 & 11.3 & 14.3 & 19.3 & 26.1 \\
25\% & 5.3 & 7.3 & 9.3 & 12.3 & 14.3 \\
50\% & 3.3 & 5.3 & 6.3 & 7.3 & 9.3 \\
100\% & 2.3 & 3.3 & 4.3 & 5.3 & 6.3 \\
\bottomrule
\end{tabular}
...
\srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07}; data in
...
This subsection is also \planned and modelled, \srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07},
...
parity-scale revenue and $\nodeshare = 0.50$. \srcdoc{scripts/07-pnr-settlement.py, run 2026-09-07};
