...
$\hopen$ \quad {\ttfamily\footnotesize\textbackslash hopen} & redemption window opens: nothing can be swapped into a retiring parallel chain; swapping back and claiming continue \\
$\hclose$ \quad {\ttfamily\footnotesize\textbackslash hclose} & retiring parallel chains shut down; residue to the Foundation \\
