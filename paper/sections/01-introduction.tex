...
specified in the \textbf{ZelCash whitepaper v2} of July 2018 \citep{zelcashwp2018}; the consensus
mechanism now called Proof of Node was specified in the Proof-of-Useful-Work v2 whitepaper
\citep{fluxpouw2}, still linked from \fluxd's own README; and the immediate predecessor to this
document is \textbf{Flux Whitepaper 2.1} \citep{fluxwp21}, which this paper supersedes rather than
amends. The author's own contemporaneous descriptions of node tiering \citep{kmentazelnode2020} and
...
compiled index this paper was given. Both articles under the author's own byline do carry confirmed
...
\planned \srcintent{evidence/design/02-pnr.md}. It is a design, stated precisely enough to build, not
...
\srcintent{08-answers-round-2.md, round 10} (\planned). The measurement above is most of the
...
\srcintent{evidence/design/00-scope.md}. It does not assert that the agent-demand premise stated in
...
this public document \srcintent{evidence/design/00-scope.md}; every \shipped claim about behaviour
...
(\srcintent{evidence/design/*.md}) that do not exist in any repository and are not measurements of
