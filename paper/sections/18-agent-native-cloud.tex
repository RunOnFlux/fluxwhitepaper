...
\begin{itemize}
  ...
  \item \emph{Silent underpayment on the direct-payment path.} A registration or update whose
    ...
    \srcintent{plan/mech-credits-renewal.md \S1.3}. For a human this is a
...
\srccode{pouwbackend/\allowbreak{}rancher/\allowbreak{}deployment.go}{914-982} \srcdoc{plan/conflicts.md, C23}. The
...
mechanism specification classes as Extension \srcintent{plan/mech-agent-identity.md \S6} --- whose
